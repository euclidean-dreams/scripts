...
class DataSourceManger:
    def __init__(self, signal, harmonic_transformer, auto_correlator):
        ...
        self.signal_derivative = ColumnDataSource()
        self.signal_double_derivative = ColumnDataSource()
        self.comparison_signal = ColumnDataSource()
        self.auto_correlated_signal = ColumnDataSource()
        self.auto_correlation_integral_data = ColumnDataSource()
        self.auto_correlated_signal_double_derivative = ColumnDataSource()
        self.auto_correlation_integral_data_double_derivative = ColumnDataSource()
    ...
    def update(self):
        ...
        self.signal_derivative.data = {
            "x": [index for index, sample in enumerate(self.auto_correlator.signal_derivative)],
            "y": self.auto_correlator.signal_derivative
        }
        self.signal_double_derivative.data = {
            "x": [index for index, sample in enumerate(self.auto_correlator.signal_double_derivative)],
            "y": self.auto_correlator.signal_double_derivative
        }
        self.comparison_signal.data = {
            "x": [index for index, sample in enumerate(self.auto_correlator.comparison_signal)],
            "y": self.auto_correlator.comparison_signal
        }
        ...
        self.auto_correlated_signal_double_derivative.data = {
            "x": [index for index, sample in enumerate(self.auto_correlator.auto_correlated_signal_double_derivative)],
            "y": self.auto_correlator.auto_correlated_signal_double_derivative
        }
        self.auto_correlation_integral_data_double_derivative.data = {
            "x": [0],
            "y": [self.auto_correlator.auto_correlation_integral_double_derivative]
        }
